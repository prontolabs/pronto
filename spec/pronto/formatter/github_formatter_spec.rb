  ...
  module Formatter
    describe GithubFormatter do
      ...
      describe '#format' do
        ...
        let(:published_comments) { "%{count} Pronto messages posted to #{formatter.pretty_name}" }
        ...
        context 'with duplicates' do
          ...
          specify do
            ...
            subject.should eq format(published_comments, count: 1)
          end
        end
        ...
        context 'without duplicates' do
          ...
          specify do
            ...
            subject.should eq format(published_comments, count: 2)
          end
        end
      end
    end
